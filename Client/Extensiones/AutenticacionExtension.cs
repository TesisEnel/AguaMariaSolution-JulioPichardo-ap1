...
namespace AguaMariaSolution.Client.Extensiones
{
    public class AutenticacionExtension : AuthenticationStateProvider
    {
        ...
        public async Task ActualizarEstadoAutenticacion(SesionAMS? sesionUsuario)
        {
        ...
        public override async Task<AuthenticationState> GetAuthenticationStateAsync()
        {
            ...
            var sesionUsuario = await _sessionStorage.ObtenerStorage<SesionAMS>("sesionUsuario");
